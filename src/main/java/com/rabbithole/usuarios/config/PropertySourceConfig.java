...
// */
// @Configuration
// @PropertySource(value = "classpath:application-secrets.properties",
// ignoreResourceNotFound = true)
// @PropertySource(value = "file:./config/application-secrets.properties",
// ignoreResourceNotFound = true)
// public class PropertySourceConfig {
// // Esta clase solo se encarga de cargar propiedades, no necesita
// implementación
// // adicional
// }
